Restricted Boltzmann Machine (author: René Alexander Ask)
-

The Restricted Boltzmann Machine (RBM) is a generative model. 
...
### Restricted Boltzmann Machine (rbm.py)
